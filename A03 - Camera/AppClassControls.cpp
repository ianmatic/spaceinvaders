...
void Application::ProcessMousePressed(sf::Event a_event)
{
	...
	case sf::Mouse::Button::Right:
		...
		//Activate First Person Camera flag
		//Used in CameraRotation
		m_bFPC = true;
		break;
	}
...
void Application::ProcessMouseReleased(sf::Event a_event)
{
	...
	case sf::Mouse::Button::Right:
		...
		//Deactivatae First Person Camera flag
		//Used in CameraRotation
		m_bFPC = false;
		break;
	}
...
void Application::CameraRotation(float a_fSpeed)
{
	...
	//Apply the angles based on mouse movement to the camera

	m_pCamera->ChangePitchAndYaw(-fAngleX * 0.25f,fAngleY * 0.25f);
