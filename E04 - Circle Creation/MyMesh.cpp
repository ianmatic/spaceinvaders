...
void MyMesh::GenerateCircle(float a_fRadius, int a_nSubdivisions, vector3 a_v3Color)
{
	...
	*/
	...
	for (int i = 0; i < a_nSubdivisions; i++) {
		...
		firstY = sinf(twoPI / a_nSubdivisions * i) * a_fRadius;
		...
		secondY = sinf(twoPI / a_nSubdivisions * (i + 1)) * a_fRadius;

		//make the triangle
		AddTri(vector3(0, 0, 0), vector3(firstX, firstY, 0), vector3(secondX, secondY, 0));
	}
