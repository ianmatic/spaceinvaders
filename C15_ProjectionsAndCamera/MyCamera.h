...
class MyCamera
{
	vector3 cameraPos = vector3(0.0f, 0.0f, 10.0f); //Where my camera is located
	vector3 cameraTarget = vector3(0.0f, 0.0f, 0.0f); //What I'm looking at
	vector3 m_v3Up = vector3(0.0f, 1.0f, 0.0f); //What is up

	vector3 cameraDirection = vector3(0.0f, 0.0f,-1.0f); //View vector
	vector3 cameraUp = vector3(0.0f, 1.0f, 0.0f); //where my head is pointing up
